...
urlpatterns = [
    ...
    path('new/grouptransaction/<int:g_id>', views.newgroupTransaction , name = 'newgrouptransaction'),
    ...
    path('home/groups/<int:g_id>' , views.gettransdatagroup , name = 'groupsdata'),
